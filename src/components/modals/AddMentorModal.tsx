...
const mentorSchema = z.object({
  ...
  assignment_start_date: z.string().optional(),
...
interface AddMentorModalProps {
  isOpen: boolean;
  onClose: () => void;
  onSubmit: (data: MentorFormData & { avatar_url?: string }) => void;
  cohortId: string;
  isLoading?: boolean;
}
  ...
  return (
    <Dialog open={isOpen} onOpenChange={handleClose}>
      <DialogContent className="max-w-lg border-border/50 bg-background/95 backdrop-blur-xl">
        <DialogHeader>
          <DialogTitle className="text-xl font-bold">Add Mentor</DialogTitle>
        </DialogHeader>
